...
do_deploy:append() {
    ...
    echo "hdmi_timings=1080 1 8 2 4 1920 1 48 6 25 0 0 0 50 0 109345300 3" >> ${DEPLOYDIR}/${BOOTFILES_DIR_NAME}/config.txt
    echo "overscan_scale=1" >> ${DEPLOYDIR}/${BOOTFILES_DIR_NAME}/config.txt
    echo "overscan_left=0" >> ${DEPLOYDIR}/${BOOTFILES_DIR_NAME}/config.txt
    echo "overscan_right=0" >> ${DEPLOYDIR}/${BOOTFILES_DIR_NAME}/config.txt
    echo "overscan_top=0" >> ${DEPLOYDIR}/${BOOTFILES_DIR_NAME}/config.txt
    echo "overscan_bottom=15" >> ${DEPLOYDIR}/${BOOTFILES_DIR_NAME}/config.txt
